<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HMIS.Master" CodeBehind="login.aspx.vb" Inherits="HMIS.login" %>
    ...
    <asp:Login ID="Login1" runat="server" style="margin-left:auto; margin-right:auto;"
                                ...
                                <LayoutTemplate>
                                    <table border="0" cellpadding="1" cellspacing="0" 
                                        style="border-collapse:collapse; padding:1px; ">
                                        <tr>
                                            <td>
                                              ...
                                              <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                                                    ...
                                                    <tr>
                                                        <td   colspan="2" style="color:Red; flex-align:center">
